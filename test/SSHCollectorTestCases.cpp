...
BOOST_AUTO_TEST_CASE(validate_ip_test) {
    BOOST_REQUIRE_MESSAGE(!AbstractCollector::isValidInternetIP({127, 0, 0, 1}), "Validate IP");
}

BOOST_AUTO_TEST_CASE(port_openning_test) {
    BOOST_REQUIRE_MESSAGE(AbstractCollector::isPortOpening({39, 105, 214, 245}, 22), "Port opening");
}
...
BOOST_AUTO_TEST_CASE (all_server_test) {
    ...
    sshsCollector->scanServers({39, 105, 214, 0}, {40, 106, 216, 256});
